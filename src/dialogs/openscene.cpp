...
namespace Slick {
    ...
    namespace Dialogs {
        ...
        namespace {
            ...
            inline QString getHipHopFilename(OpenScene* parent)
            {
        ...
        OpenScene::HipHopGroup::HipHopGroup(OpenScene* dialog, const QString& text) :
            ...
            valid(true)
        {
            connect(checkBox, &QCheckBox::stateChanged, dialog, &OpenScene::updateWidgets);
            connect(lineEdit, &QLineEdit::textChanged, dialog, &OpenScene::updateWidgets);
            connect(browseButton, &QPushButton::clicked, dialog, &OpenScene::browse);
        ...
        void OpenScene::HipHopGroup::update()
        {
        ...
        void OpenScene::HipHopGroup::setPath(const QString& path)
        {
        ...
        OpenScene::InfoGroup::InfoGroup(OpenScene* dialog, const QString& text) :
            layout(new QHBoxLayout),
            label(new QLabel(text)),
            comboBox(new QComboBox),
            valid(true)
        {
            connect(comboBox, QOverload<int>::of(&QComboBox::currentIndexChanged), dialog, &OpenScene::updateWidgets);

            layout->addWidget(label);
            layout->addWidget(comboBox, 1);
        }

        void OpenScene::InfoGroup::update()
        {
        ...
        OpenScene::LocGroup::LocGroup(OpenScene* dialog, const QString& text) :
            dialog(dialog),
            ...
            valid(true)
        {
            ...
            connect(tableWidget, &QTableWidget::itemChanged, dialog, &OpenScene::updateWidgets);
        ...
        void OpenScene::LocGroup::update()
        {
            valid = true;
        ...
        void OpenScene::LocGroup::addPath(const QString& path)
        {
        ...
        void OpenScene::LocGroup::setPaths(const QStringList& paths)
        {
            tableWidget->clear();
        ...
        OpenScene::LocGroup::Item OpenScene::LocGroup::createItem(const QString& path)
        {
            Item item;
        ...
        OpenScene::OpenScene(QWidget* parent, Qt::WindowFlags f) :
            QDialog(parent, f),
        ...
        QString OpenScene::hipPath() const
        {
            return m_hip.lineEdit->text();
        }

        QString OpenScene::hopPath() const
        {
            return m_hop.lineEdit->text();
        }

        QStringList OpenScene::locHipPaths() const
        {
            QStringList paths;
