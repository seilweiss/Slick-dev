...
namespace Slick {
    ...
    namespace Assets {
        ...
        BoulderAsset::BoulderAsset(HipHop::Asset asset, SceneFile* sceneFile) :
        ...
        void BoulderAsset::inspect(Inspector* inspector)
        {
            EntAsset::inspect(inspector);

            auto boulderGroup = inspector->addGroup("boulder", tr("Boulder"));
            ...
            connect(gravityProp, &InspectorProperty::dataChanged, this, &BoulderAsset::makeDirty);
            connect(massProp, &InspectorProperty::dataChanged, this, &BoulderAsset::makeDirty);
            connect(bounceProp, &InspectorProperty::dataChanged, this, &BoulderAsset::makeDirty);
            connect(frictionProp, &InspectorProperty::dataChanged, this, &BoulderAsset::makeDirty);
            connect(statFricProp, &InspectorProperty::dataChanged, this, &BoulderAsset::makeDirty);
            connect(maxVelProp, &InspectorProperty::dataChanged, this, &BoulderAsset::makeDirty);
            connect(maxAngVelProp, &InspectorProperty::dataChanged, this, &BoulderAsset::makeDirty);
            connect(stickinessProp, &InspectorProperty::dataChanged, this, &BoulderAsset::makeDirty);
            connect(bounceDampProp, &InspectorProperty::dataChanged, this, &BoulderAsset::makeDirty);
            connect(killTimerProp, &InspectorProperty::dataChanged, this, &BoulderAsset::makeDirty);
            connect(hitpointsProp, &InspectorProperty::dataChanged, this, &BoulderAsset::makeDirty);
            connect(soundIDProp, &InspectorProperty::dataChanged, this, &BoulderAsset::makeDirty);
            connect(volumeProp, &InspectorProperty::dataChanged, this, &BoulderAsset::makeDirty);
            connect(minSoundVelProp, &InspectorProperty::dataChanged, this, &BoulderAsset::makeDirty);
            connect(maxSoundVelProp, &InspectorProperty::dataChanged, this, &BoulderAsset::makeDirty);
            connect(innerRadiusProp, &InspectorProperty::dataChanged, this, &BoulderAsset::makeDirty);
            connect(outerRadiusProp, &InspectorProperty::dataChanged, this, &BoulderAsset::makeDirty);
            connect(sphereRadiusProp, &InspectorProperty::dataChanged, this, &BoulderAsset::makeDirty);
            connect(boneIndexProp, &InspectorProperty::dataChanged, this, &BoulderAsset::makeDirty);
            connect(canHitWallsProp, &InspectorProperty::dataChanged, this, &BoulderAsset::makeDirty);
            connect(damagePlayerProp, &InspectorProperty::dataChanged, this, &BoulderAsset::makeDirty);
            connect(unk0x4Prop, &InspectorProperty::dataChanged, this, &BoulderAsset::makeDirty);
            connect(damageNPCsProp, &InspectorProperty::dataChanged, this, &BoulderAsset::makeDirty);
            connect(unk0x10Prop, &InspectorProperty::dataChanged, this, &BoulderAsset::makeDirty);
            connect(dieOnOOBSurfsProp, &InspectorProperty::dataChanged, this, &BoulderAsset::makeDirty);
            connect(unk0x40Prop, &InspectorProperty::dataChanged, this, &BoulderAsset::makeDirty);
            connect(unk0x80Prop, &InspectorProperty::dataChanged, this, &BoulderAsset::makeDirty);
            connect(dieOnPlayerHitProp, &InspectorProperty::dataChanged, this, &BoulderAsset::makeDirty);
            connect(dieOnKillTimerProp, &InspectorProperty::dataChanged, this, &BoulderAsset::makeDirty);
