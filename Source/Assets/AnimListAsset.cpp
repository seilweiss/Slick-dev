...
namespace Slick {
    ...
    namespace Assets {
        ...
        namespace {
            ...
            class AnimListSource : public AbstractInspectorListSource
            {
            public:
                ...
                virtual void createGroupItem(InspectorGroup* group, int index) override
                {
                    ...
                    QObject::connect(itemProp, &InspectorProperty::dataChanged, m_asset, &AnimListAsset::makeDirty);
                }
        ...
        AnimListAsset::AnimListAsset(HipHop::Asset asset, SceneFile* sceneFile) :
        ...
        void AnimListAsset::inspect(Inspector* inspector)
        {
            auto animListGroup = inspector->addGroup("animList", tr("Anim List"));
